...
const dictionaries = {
  en: {
    ...
    contextAny: "Any",
    updated: "Updated",
    localOpenApi: "Local OpenAPI",
    matchedOpenApi: "Matched OpenAPI",
    operation: "Operation",
    example: "Example",
    ...
    mediaCount: (count: number) => `${count} media`,
    checkStatus: "Check status",
    checkingTaskStatus: "Checking task status...",
    openApiDocument: "OpenAPI document",
    showOpenApiDoc: "Show OpenAPI document",
    hideOpenApiDoc: "Hide OpenAPI document",
    ...
    noGenerationModels: "No matched local OpenAPI models found.",
    noGenerationResults: "No generation models match the current search.",
    pricing: "Pricing",
  ...
  zh: {
    ...
    contextAny: "不限",
    updated: "更新时间",
    localOpenApi: "本地 OpenAPI",
    matchedOpenApi: "匹配的 OpenAPI",
    operation: "操作",
    example: "示例",
    parameters: "参数",
    generate: "生成",
    ...
    readyToGenerate: "等待生成",
    download: "下载",
    localRecords: "本地记录",
    mediaCount: (count: number) => `${count} 个媒体`,
    checkStatus: "查询状态",
    checkingTaskStatus: "正在查询任务状态...",
    openApiDocument: "OpenAPI 文档",
    showOpenApiDoc: "查看 OpenAPI 文档",
    hideOpenApiDoc: "收起 OpenAPI 文档",
    requestPreview: "请求预览",
    curl: "curl",
    copyRequest: "复制请求",
    copyCurl: "复制 curl",
    ...
    addItem: "添加条目",
    removeItem: "移除条目",
    noGenerationModels: "没有匹配到本地 OpenAPI 的模型。",
    noGenerationResults: "没有匹配当前搜索条件的生成模型。",
    pricing: "价格",
