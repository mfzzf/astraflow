...
import {
  PromptInputButton,
  PromptInputTools,
} from '@/components/playground/ai-elements/prompt-input'
import { ConfirmDialog } from '@/components/playground/confirm-dialog'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import {
  ...
  TooltipContent,
  TooltipTrigger,
} from '@/components/playground/ui/tooltip'
