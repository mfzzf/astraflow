...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@/components/playground/ui/dropdown-menu'
import type { DropdownMenuItemSelectEvent } from '@/components/playground/ui/dropdown-menu-events'
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger,
} from '@/components/playground/ui/hover-card'
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from '@/components/playground/ui/input-group'
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@/components/playground/ui/select'
...
export const PromptInputActionAddAttachments = ({
  ...
  return (
    <DropdownMenuItem
      {...props}
      onSelect={(e: DropdownMenuItemSelectEvent) => {
        e.preventDefault()
